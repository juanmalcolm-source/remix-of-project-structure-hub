...
import {
  Library, CalendarDays, Briefcase, ListChecks, Landmark,
  LogOut, Save, Settings, Palette, Clapperboard, Wallet, Megaphone, Menu,
} from 'lucide-react';
    ...
    <>
      ...
      <nav className="flex-1 py-4 px-3 space-y-1 overflow-y-auto">
        {tabs.map((tab) => {
          ...
          return (
            <button key={tab.id} onClick={() => navigateTo(tab.path)} className={cn('sidebar-link w-full text-left', isActive && 'sidebar-link-active bg-amber-500/10 text-amber-700')}>
