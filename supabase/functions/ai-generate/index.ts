...
serve(async (req) => {
  ...
  try {
    const { prompt, systemPrompt, maxTokens = 2048 } = await req.json();
    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: systemPrompt || "Eres un asistente experto en producción cinematográfica española y europea. Responde siempre en español.",
          },
